...
A total of 19 participants took part in an online version of a Perception of Randomness task.
There were 5 male, 12 female and 2 participants who chose not to answer, with ages ranging from 20 to 64. There were 10 participants in the discrimination condition and 9 in the identification condition. The first 4 participants contributed 510 data points (10 for each switch rate), the subsequent participants contributed 6 data points for each switch rate plus 10 practice trials.
