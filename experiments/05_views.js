...
const instructions_identification = magpieViews.view_generator("instructions", {
  ...
  name: 'instructions',
  title: 'General Instructions',
  text: `This is a sample sample sample instructions view.
            <br />
            <br />
            Tell your participants what they are to do here.`,
  buttonText: 'go to trials'
...
const key_press_discrimination = magpieViews.view_generator("key_press", {
  // This will use all trials specified in `data`, you can user a smaller value (for testing), but not a larger value
  trials: trial_info.key_press.length,
  // name should be identical to the variable name
  name: 'key_press_discrimination',
...
const key_press_identification = magpieViews.view_generator("key_press", {
  // This will use all trials specified in `data`, you can user a smaller value (for testing), but not a larger value
  trials: trial_info.key_press.length,
  // name should be identical to the variable name
  name: 'key_press_identification',
  data: trial_info.key_press,
  // you can add custom functions at different stages through a view's life cycle
  // hook: {
  //     after_response_enabled: check_response
